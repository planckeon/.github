...
<img src="logo.png" alt="Planckeon Labs" width="150" height="150">

# Planckeon Labs

**R&D in fast | intelligent software tooling for theoretical physics**

[![GitHub](https://img.shields.io/badge/GitHub-planckeon-181717?logo=github)](https://github.com/planckeon)
...
|------------|-------------|--------|
| [**autograv**](https://github.com/planckeon/autograv) | Bridging numerical relativity and automatic differentiation using JAX | Active |
| [**pauliz**](https://github.com/planckeon/pauliz) | High-performance, zero-dependency quantum computing simulation in Zig | Active |
| [**attn-as-bilinear-form**](https://github.com/planckeon/attn-as-bilinear-form) | Transformer attention via tensor calculus, statistical mechanics & differential geometry | Research |
...
1. Licata, I., Tamburini, F., & Fiscaletti, D. (2025). *Planckeons as mouths of quantum wormholes and holographic origin of spacetime*. [arXiv:2505.02804](https://arxiv.org/abs/2505.02804)

### ER=EPR & Emergent Spacetime

2. Maldacena, J., & Susskind, L. (2013). *Cool horizons for entangled black holes*. [arXiv:1306.0533](https://arxiv.org/abs/1306.0533)

3. Van Raamsdonk, M. (2010). *Building up spacetime with quantum entanglement*. [arXiv:1005.3035](https://arxiv.org/abs/1005.3035)

4. Ryu, S., & Takayanagi, T. (2006). *Holographic derivation of entanglement entropy from AdS/CFT*. [arXiv:hep-th/0603001](https://arxiv.org/abs/hep-th/0603001)

### Quantum Gravity Landscape

5. Buoninfante, L., et al. (2024). *Visions in Quantum Gravity*. [arXiv:2412.08696](https://arxiv.org/abs/2412.08696)

---

## Connect

- **Research Inquiries**: [Open an issue](https://github.com/planckeon/.github/issues)
